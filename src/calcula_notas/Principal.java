...
public class Principal extends JFrame implements ActionListener{
	...
	public Principal() throws IOException {
		...
		String diretorioCalc = "calculadora.png";
		java.net.URL resourc = getClass().getResource(diretorioCalc);
		File fil;
		try {
			fil = new File(resourc.toURI());
			ImageIcon icone = new ImageIcon(fil.getPath());
			setIconImage(icone.getImage());
		} catch (URISyntaxException e2) {
			// TODO Auto-generated catch block
			System.out.println("deu erro no icone");
			e2.printStackTrace();
		}							
		...
		ler.close();
		abrir.close();
		//-------------------------Final das Disciplina---------JTextField------------------------------
		...
		lblSistemaDesenvolvidoPor.setBounds(314, 406, 350, 14);
	...
	public void actionPerformed(ActionEvent e) {
		 Object o = e.getSource();  
	        if (o==btnCalcularModulo) {         
	        	...
	        	tffinalModulo.setText(fazer.notaFinaldoModulo(finalDisciplina[0],finalDisciplina[1],finalDisciplina[5], finalDisciplina[3], finalDisciplina[2],finalDisciplina[4]));
	        	...
	        	//---------------CALCULA PT TOTAL E FAZ A MEDIA DE INGLES e MATEMATICA------------
	        	...
	        	salvaNotasSemanais();		//salva as notas no arquivo .txt
